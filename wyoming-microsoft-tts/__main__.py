...
async def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Maximum number of microsoft process to run simultaneously (default: 1)",
    )
    #
    parser.add_argument(
        "--update-voices",
    ...
    voices = [
        TtsVoice(
            ...
            attribution=Attribution(
                name="rhasspy", url="https://github.com/rhasspy/microsoft"
            ),
            installed=True,
            languages=[
    ...
    process_manager = MicrosoftProcessManager(args, voices_info)
